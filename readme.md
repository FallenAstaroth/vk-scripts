...
Запускаем Msg.py. Когда в консоли начнут выводится только сообщения "Сообщения отправлены", "Возобновление процесса накрутки" и ничего больше - можно выключать скрипт, все существующие диалоги и беседы помечены непрочитанными.
## Компиляция
